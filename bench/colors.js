...
bench('All Colors')
	...
	.add('terminalstyle', () => {
		names.forEach(name => terminalstyle[name]('foo'));
	})
	.add('terminalstyle/colors', () => {
...
bench('Stacked colors')
	...
	.add('terminalstyle', () => {
		names.forEach(name => terminalstyle[name]().bold().underline().italic('foo'));
	})
	.add('terminalstyle/colors', () => {
...
bench('Nested colors')
	...
	.add('terminalstyle', () => fixture(terminalstyle))
	.add('terminalstyle/colors', () => fixture(colors))
	.run();
